...
class TesttableRepository extends BaseRepository implements TesttableRepositoryInterface
{
    ...
    public function findAll($params) : array
    {
        ...
        if (isset($params['filter'])) {
            ...
            if (isset($filter['testfield'])) {
                $query->where('testfield', 'like', '%'.$filter['testfield'].'%');
            }
    ...
    public function create(array $attributes, $currentUser)
    {
        try {
            ...
            $testtable = Testtable::create([
                    'testfield' => $attributes['testfield'] ?? null
,
