...
import TableSamplePermissions from '@/components/Permissions/TableSamplePermissions.vue'
...
const onConfirmCsv = async () => {
  if (csvFile.value) {
    ...
    permissionsStore.fetch(null, query.value);
...
<CardBoxModal
  ...
  <SectionHeroBar>Permissions</SectionHeroBar>
  <SectionMain>
    <BaseButtons>
      <BaseButton
        color="default"
  ...
  <SectionMain>
  <a class="text-blue-500 hover:text-blue-600 active:text-blue-700 mb-3 block" :href="externalLink">API documentation for permissions</a>
    ...
    <CardBox
      ...
      has-table
    >
      <TableSamplePermissions checkable :sortTitle="sortTitle" :sortDirection="sortDirection" @sort="sortTable($event)" />
    </CardBox>
