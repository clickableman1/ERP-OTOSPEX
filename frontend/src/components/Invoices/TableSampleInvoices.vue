...
/* Delete item */
const deleteItem = () => {
  invoicesStore.deleteItem(currentId.value)
}

const items = computed(() => invoicesStore.data)
  ...
  <table>
    ...
    <tbody>
      <tr
        ...
        :key="client.id"
        @click="$router.push(`/invoices/${client.id}/edit`)"
      >
        <TableCheckboxCell
          v-if="checkable"
