...
/* Delete item */
const deleteItem = () => {
  suppliersStore.deleteItem(currentId.value)
}

const items = computed(() => suppliersStore.data)
  ...
  <table>
    ...
    <tbody>
      <tr
        ...
        :key="client.id"
        @click="$router.push(`/suppliers/${client.id}/edit`)"
      >
        <TableCheckboxCell
          v-if="checkable"
