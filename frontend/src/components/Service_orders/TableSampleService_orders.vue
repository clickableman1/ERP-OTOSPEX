...
service_ordersStore.fetch()

/* Delete item */
const deleteItem = () => {
  service_ordersStore.deleteItem(currentId.value)
}

const items = computed(() => service_ordersStore.data)
  ...
  <table>
    ...
    <tbody>
      <tr
        ...
        :key="client.id"
        @click="$router.push(`/service_orders/${client.id}/edit`)"
      >
        <TableCheckboxCell
          v-if="checkable"
        ...
        <td class="before:hidden lg:w-1 whitespace-nowrap">
          ...
          >
            <BaseButton
              ...
              :icon="mdiEye"
              small
              :to="`/service_orders/${client.id}/edit`"
            />
            <BaseButton
              color="danger"
              :icon="mdiTrashCan"
