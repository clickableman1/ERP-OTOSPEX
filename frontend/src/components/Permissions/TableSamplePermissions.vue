...
/* Delete item */
const deleteItem = () => {
  permissionsStore.deleteItem(currentId.value)
}

const items = computed(() => permissionsStore.data)
  ...
  <table>
    ...
    <tbody>
      <tr
        ...
        :key="client.id"
        @click="$router.push(`/permissions/${client.id}/edit`)"
      >
        <TableCheckboxCell
          v-if="checkable"
