...
sale_ordersStore.fetch()

/* Delete item */
const deleteItem = () => {
  sale_ordersStore.deleteItem(currentId.value)
}

const items = computed(() => sale_ordersStore.data)
  ...
  <table>
    ...
    <tbody>
      <tr
        ...
        :key="client.id"
        @click="$router.push(`/sale_orders/${client.id}/edit`)"
      >
        <TableCheckboxCell
          v-if="checkable"
