...
order_detailsStore.fetch()

/* Delete item */
const deleteItem = () => {
  order_detailsStore.deleteItem(currentId.value)
}

const items = computed(() => order_detailsStore.data)
  ...
  <table>
    ...
    <tbody>
      <tr
        ...
        :key="client.id"
        @click="$router.push(`/order_details/${client.id}/edit`)"
      >
        <TableCheckboxCell
          v-if="checkable"
        ...
        <td class="before:hidden lg:w-1 whitespace-nowrap">
          ...
          >
            <BaseButton
              ...
              :icon="mdiEye"
              small
              :to="`/order_details/${client.id}/edit`"
            />
            <BaseButton
              color="danger"
              :icon="mdiTrashCan"
